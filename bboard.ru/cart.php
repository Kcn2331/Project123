        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row row-reviews">
					...
					<div class="div-cart">
						<p class="pull-right"><button class="button-delete-from-cart" onclick="delete_from_cart(<?php echo $cart['cart_id'];?>)">Удалить</button></p>
                    ...
                    <?php } ?>
					<p id="sum">Итого = <?php echo $sum; ?> руб.</p>
					<button onclick="location.href='order.php?sum=<?php echo $sum?>'">Оформить заказ</button>
					<?php } else echo "<h1 class='title-page'>Для просмотра необходимо войти!</h1>"?>
                </div>
            </div>
        </div>
    </div>
